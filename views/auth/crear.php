<h1 class="nombre-pagina">Crear una cuenta nueva</h1>
...
<form class="formulario" method="POST" action="/crear">
    ...
    <div class="campo">
        ...
        <input type="email" id="email" name="email" placeholder="p.ej correo@correo.com" value="<?php echo s($usuario->email);?>"/>
    </div>
    <div class="campo">
